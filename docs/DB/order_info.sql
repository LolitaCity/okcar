...
CREATE TABLE `order_info` (
  ...
  `order_app_deco_id` int(11) DEFAULT NULL COMMENT '订单外观内饰id',
  ...
  `appearance_decoration` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '外观,内饰',
  ...
  KEY `public_info_appearance_index` (`appearance_decoration`),
